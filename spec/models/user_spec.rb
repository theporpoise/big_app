...
describe User do
  ...
  it { shoudl respond_to(:followers) }
  ...
  describe "micropost associations" do
    ...
    it "should destroy associated mircroposts" do
  ...
  describe "when email address is already taken capitalize" do
  	before do
  		user_with_same_email = @user.dup
